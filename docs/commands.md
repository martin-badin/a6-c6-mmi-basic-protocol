...
Additional notes and examples remain in the individual command documents. If
you'd like further splitting (one file per observed sub-type or sample), I can
create `docs/commands/<id>-<sample>.md` files as well.
